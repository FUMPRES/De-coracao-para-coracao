            ...
            idososArray.forEach(idoso => {
                ...
                card.innerHTML = `
                    ...
                    <label for="check-${idoso.id}">
                        <span class="nome">${idoso.Nome}</span>, <span class="idade">${idoso.Idade} anos</span>, <span class="sexo">${idoso.Sexo}, <span class="Calçado">${idoso.Calçado}, <span class="Roupa">${idoso.Roupa}</span>
